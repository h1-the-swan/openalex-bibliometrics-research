...
def get_csv_files_info(csv_dir):
    csv_files = {
        'authors': {
            'authors': {
...
def flatten_authors(snapshot_dir, csv_files):
...
def flatten_concepts(snapshot_dir, csv_files):
...
def flatten_institutions(snapshot_dir, csv_files):
...
def flatten_publishers(snapshot_dir, csv_files):
...
def flatten_sources(snapshot_dir, csv_files):
...
def flatten_works(snapshot_dir, csv_files):
...
def main(args):
    ...
    csv_files = get_csv_files_info(args.outdir)
    # flatten_authors(snapshot_dir, csv_files)
    # flatten_concepts(snapshot_dir, csv_files)
    # flatten_institutions(snapshot_dir, csv_files)
    # flatten_publishers(snapshot_dir, csv_files)
    # flatten_sources(snapshot_dir, csv_files)
    flatten_works(snapshot_dir, csv_files)
